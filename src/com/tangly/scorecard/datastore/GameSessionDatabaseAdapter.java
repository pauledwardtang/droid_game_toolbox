...
public class GameSessionDatabaseAdapter extends DefaultDatabaseAdapter implements DatabaseAdapter
{
    ...
    public long insert(SQLiteDatabase db, Storable s)
    {
        ...
        for (Player p : gs.getPlayers())
        {
            ...
            db.insertWithOnConflict("GameSession_Player", null, linkTableValues,
    ...
    public void update(SQLiteDatabase db, Storable s)
    {
        ...
        {
            updateGameSessionStatement = db
                    .compileStatement("UPDATE GameSession SET name=:1 WHERE id=:2");
        }
        ...
        // TODO This approach doesn't work for some reason. It fails to bind the
        // name and ID
        // ContentValues values = new ContentValues();
