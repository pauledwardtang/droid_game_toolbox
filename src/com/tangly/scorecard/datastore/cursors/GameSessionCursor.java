...
{
    private static final String BASE_QUERY = "SELECT * FROM GameSession ";

    private static final String GS_SELECT_QUERY = "SELECT * FROM GameSession WHERE id = ";
    ...
    /**
     * @return the SQL string that retrieves Players associated with a
     *         particular GameSession. GS ID MUST BE APPENDED and WILL return a
     *         player, not a gamesession
     */
