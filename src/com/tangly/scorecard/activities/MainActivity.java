...
public class MainActivity extends FragmentActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mDrawerList.setAdapter(new ArrayAdapter<String>(this,
                R.layout.drawer_list_item, ListAction.toArray()));
    ...
    public boolean onPrepareOptionsMenu(Menu menu)
    {
        ...
        // Always hide the websearch icon
    ...
    private void selectItem(int position)
    {
        ...
        ListAction action = ListAction.values()[position];
        Fragment fragment = null;
        switch (action)
        {
        case GAMES:
            fragment = new ManageGamesFragment();
            break;
        case PLAYERS:
            fragment = new ManagePlayersFragment();
            break;
        case DICE:
            fragment = new ManageDiceFragment();
            break;
        // case ABOUT:
        // break;
        default:
        ...
        setTitle(ListAction.values()[position].toString());
