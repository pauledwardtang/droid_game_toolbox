...
public class DatastoreRetrieveTask extends AsyncTask<Long, Void, Collection<Storable>>
{
    ...
    /**
     * @param ds
     *            The Datastore instance to use to retrieve results
     * @param recordType
     *            The record type to retrieve
     * @param results
     *            The reference to the collection that will be populated with
     *            the results of this Task
     */
    public DatastoreRetrieveTask(Datastore ds, Class<? extends Storable> recordType,
