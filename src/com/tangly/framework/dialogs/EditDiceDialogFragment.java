...
public class EditDiceDialogFragment extends NoticeDialogFragment
{
	 ...
	 * populate the fields you MUST call setArguments with a bundle using the public bundle
	 * strings provided in this class
	 */
	...
	public Dialog onCreateDialog(Bundle savedInstanceState)
	{
		...
		RelativeLayout view = (RelativeLayout) inflater.inflate(R.layout.new_dice, null);
		
		// Populate the view instances
		this.diceName = (EditText) ((LinearLayout) view.getChildAt(0)).getChildAt(1);
		this.numSides = (NumberPicker) ((LinearLayout) view.getChildAt(1)).getChildAt(1);
	...
	private void populateFieldsFromSavedStateOrArgument(Bundle savedInstance, Bundle args)
	{
		if (savedInstance != null)
		{
			if (savedInstance.containsKey(BUNDLE_DICE_NAME))
				this.diceName.setText(savedInstance.getString(BUNDLE_DICE_NAME));
