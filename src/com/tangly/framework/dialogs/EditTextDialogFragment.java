 ...
 */
@SuppressLint ("ValidFragment") // TODO Clean up non-empty constructor lint issues
public class EditTextDialogFragment extends NoticeDialogFragment
{
    ...
    // TODO non-default constructors are highly discouraged since the restoring
    // the state will use the empty args cstor
    // TODO when this is fixed, remove the lint.xml
    /**
     * Populates a default title and a text field with the given default text
     * 
     * @param defaultText
     *            The given default text with which to populate the text field
     */
