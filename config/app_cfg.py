# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in GameOn.
...
from gameon.lib import app_globals, helpers 
...
base_config.model = gameon.model
base_config.DBSession = gameon.model.DBSession
# Configure the authentication backend

#pluggable is included so we can add the FB auth plugin in the future
